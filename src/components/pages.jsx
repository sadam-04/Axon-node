        ...
        <div style={{display: "flex", flexDirection: "row", height: "100%", width: "100%"}}>
            <div id="left-summary-panel" style={{display: "flex", flexDirection: "column", boxSizing: "content-box"}}>
                <div style={{display: "flex", flexDirection: "column", maxHeight: "100%"}}>
                    <div className="left-send-header" onClick={() => {setSelectedSFile(null);}} style={{ display: "flex", justifyItems: "space-between", flexDirection: "column", marginBottom: "4px"}}>
                    ...
                    <div style={{display: "flex", flexDirection: "row", padding: "0px 0px 0px 0px", width: "94%", margin: "auto"}}>
                        <form onSubmit={(e) => {handleAddText(e, setHostedFiles, setSelectedSFile, addTextValue, setAddTextValue, protocolRef, ipRef, portRef);}} style={{display: "block", boxSizing: "border-box", width:"calc(100% - 30px)", marginRight: "4px"}}>
                            <input type="text" value={addTextValue} onChange={(e) => setAddTextValue(e.target.value)} id="addtext" name="addtext" placeholder="add text, press enter to save" class="theme-text-input" style={{width: "100%", backgroundColor: "#202020"}}/>
                        </form>
                        <ResponsiveButton 
                    ...
                    {hostedFiles.map((file, i) => (
                        ...
                        enabled={true}
                        customStyle={{borderRadius: "6px", width: "94%", height: "30px", margin: "2px auto 2px auto"}}
                        shadeA={"#282828"}
                        shadeB={"#303030"}
                        shadeC={"#343434"}
                        />
    ...
    return (
        <div style={{display: "flex", flexDirection: "row", height: "100%", width: "100%"}}>
            ...
            <div id="recv-panel" style={{display: "flex", flexDirection: "column", height: "100%"}}>
                <div className="left-recv-header" onClick={() => {setSelectedRFile(null);}} style={{ display: "flex", justifyItems: "space-between", flexDirection: "column", marginBottom: "2px" }}>
